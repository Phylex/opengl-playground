...
Polyline::Polyline(std::vector<glm::vec3> &in_points, ShaderProgram *in_shader) {
	points = in_points;
	shader = in_shader;
...
void Polyline::add_points(glm::vec3 point) {
...
void Polyline::add_points(std::vector<glm::vec3>& add_points) {
